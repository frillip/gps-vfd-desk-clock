...
#define USER_CMD_PIC_SHOW_CONFIG_STRING "pic-config-show"
#define USER_CMD_PIC_SHOW_EEPROM_STRING "pic-eeprom-show"
#define USER_CMD_PIC_CLEAR_ALL_STRING "pic-config-clear"
